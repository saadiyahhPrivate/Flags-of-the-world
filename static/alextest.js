...
function createMap(data) {
	...
	countryName.append('text')
		...
		.attr('y', 20)
		.attr('fill', 'blue')
		.text('Hover over a country to see its flag!')
	...
	svg.selectAll("g")
        ...
        .on('mouseout', function(d) {
            ...
            countryName.text("Hover over a country to see its flag!");
            flagimage.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
            flagimage.border="0";
            }
        });
